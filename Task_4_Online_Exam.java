...
{  
    ...
    {  
        ...
        if(current==1)  
        {  
            l.setText("Q2:When is the object created with new keyword?");  
            jb[0].setText("At run-time");jb[1].setText("at compile-time");jb[2].setText("Depends on code");jb[3].setText("None");  
        }  
        if(current==2)  
        {  
            l.setText("Q3: Where is system class defined?");  
            jb[0].setText("java.lang.package");jb[1].setText("java.util.package ");jb[2].setText("java.lo.package");jb[3].setText("None");  
        }  
        if(current==3)  
        {  
            l.setText("Q4: Expected created by try block is caaught in which block.?");  
        ...
        if(current==6)  
        {  
            l.setText("Q7: When is the finalize()method called ");  
        ...
        if(current==7)  
        {  
            l.setText("Q8: What is the implict return type of constructor?");  
        ...
        if(current==9)  
        {  
            l.setText("Q10: When an array is passed to a method, what does the method receive?");  
            jb[0].setText("The reference of the array");jb[1].setText("copy of the array");jb[2].setText("length of the array");  
